...
function Cartapp(){
 ...
 <nav className="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <section className="py-5">
          ...
          setCount(count+1)}} className="btn btn-outline-dark mt-auto" href="#">Add to cart</a>   <a onClick={()=>{
            setCount(count-1)}} className="btn btn-outline-dark mt-auto" href="#">Remove from cart</a> </div>
